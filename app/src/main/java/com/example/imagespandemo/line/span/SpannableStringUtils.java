...
public class SpannableStringUtils {
    ...
    public static class Builder {
         ...
         * @return {@link Builder}
         */
        public Builder setBitmap(@NonNull Bitmap bitmap, Context context) {
            this.bitmap = bitmap;
            imageIsBitmap = true;
         ...
         * @return {@link Builder}
         */
        public Builder setDrawable(@NonNull Drawable drawable, Context context) {
         ...
         * @return {@link Builder}
         */
        public Builder setResourceId(@DrawableRes int resourceId,Context context) {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId || imageIsSpan) {
                if (imageIsBitmap) {
