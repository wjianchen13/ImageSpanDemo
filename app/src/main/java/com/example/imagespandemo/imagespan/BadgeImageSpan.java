 ...
 * 绘制粉丝等级
 */
public class BadgeImageSpan extends ImageSpan {
    ...
    public BadgeImageSpan(Drawable d, Context context, String sid, String badge, int align) {
...
//        canvas.drawRect(new Rect(xl, 11, xl + bLevel.width(), yl + bLevel.bottom), paint);
