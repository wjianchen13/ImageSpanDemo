...
public class MyAdapter1 extends RecyclerView.Adapter<MyAdapter1.ViewHolder>{
    ...
    public MyAdapter1(Context context, List<Integer> dataset) {
        super();
...
//        View view = View.inflate(viewGroup.getContext(), R.layout.item_test, null);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        SpannableString fansImageSpan = SpanUtils.getBadgeImageSpan1(mContext, Integer.toString(mDataset.get(i)),  ScreenUtils.dip2px(mContext, 17), ImageSpanAlign.XIU_ALIGN_CENTER);
